...
function Header({setlogged}){
   ...
   // setname(firebase.auth().currentUser.displayName)
    return(
        <div style={{backgroundColor:"blueviolet",padding:'10px',display:'flex',flexDirection:'row',alignItems:'center',width:'100%'}}>
            ...
            <span style={{color:'white',fontSize:'22px',fontWeight:"800",width:'60px',height:'100%',padding:"5px",paddingRight:'10px'}} >
               Hi  {Name!==''?Name:null}
            </span>
        </div>
    )
